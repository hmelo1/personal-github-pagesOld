      ...
      <Grid container spacing={12}>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <Paper className={classes.root} elevation={0}>
            ...
            <br />
            <Typography component="p">
             Frontend is built using ReactJs with Redux acting as the middleware.
            </Typography>
            <a href="https://warm-scrubland-67229.herokuapp.com/">
              Hosted on Heroku:<br/>
              <Button><Cloud /></Button>
            </ a>
            <br />
            <a href="https://github.com/hmelo1/pho-nomenal">
              Code on Github:<br />
